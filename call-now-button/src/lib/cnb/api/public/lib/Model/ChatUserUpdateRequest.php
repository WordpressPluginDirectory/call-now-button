...
class ChatUserUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Updated display name of the chat agent
     *
     * @return self
     */
     ...
     * Sets avatar_url
     *
     * @param string|null $avatar_url Updated URL of the agent's avatar image
     *
     * @return self
     */
     ...
     *
     * @param string|null $availability_status Updated availability status of the agent
     *
     * @return self
     */
