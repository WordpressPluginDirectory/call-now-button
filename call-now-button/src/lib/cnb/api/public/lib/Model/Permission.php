...
class Permission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of this permission record
     *
     * @return self
     */
     ...
     * Sets member
     *
     * @param \cnb\api\Model\WsMember $member The workspace member this permission is granted to
     *
     * @return self
     */
     ...
     * Sets permission
     *
     * @param string $permission The permission type granted
     *
     * @return self
     */
