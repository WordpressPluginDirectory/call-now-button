...
class CheckoutSessionStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets domain
     *
     * @param string|null $domain The ID of the domain this session is for (empty if subscription type is Agency)
     *
     * @return self
     */
     ...
     *
     * @param string $subscription_id The ID of the subscription if already created, empty otherwise
     *
     * @return self
     */
