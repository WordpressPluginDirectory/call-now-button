...
class ChatAgentPersona implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the agent persona
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Display name of the chat agent
     *
     * @return self
     */
     ...
     * Sets avatar_url
     *
     * @param string $avatar_url URL of the agent's avatar image
     *
     * @return self
     */
     ...
     *
     * @param string $availability_status Current availability status of the agent
     *
     * @return self
     */
