 ...
 *
 * The version of the OpenAPI document: 0.0.235-development
...
class MultiButtonOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['icon_background_color']) && (mb_strlen($this->container['icon_background_color']) > 255)) {
            $invalidProperties[] = "invalid value for 'icon_background_color', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['icon_background_color']) && (mb_strlen($this->container['icon_background_color']) < 0)) {
            $invalidProperties[] = "invalid value for 'icon_background_color', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['icon_color']) && (mb_strlen($this->container['icon_color']) > 255)) {
            $invalidProperties[] = "invalid value for 'icon_color', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['icon_color']) && (mb_strlen($this->container['icon_color']) < 0)) {
            $invalidProperties[] = "invalid value for 'icon_color', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['label_text_color_open']) && (mb_strlen($this->container['label_text_color_open']) > 255)) {
            $invalidProperties[] = "invalid value for 'label_text_color_open', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['label_text_color_open']) && (mb_strlen($this->container['label_text_color_open']) < 0)) {
            $invalidProperties[] = "invalid value for 'label_text_color_open', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['label_background_color_open']) && (mb_strlen($this->container['label_background_color_open']) > 255)) {
            $invalidProperties[] = "invalid value for 'label_background_color_open', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['label_background_color_open']) && (mb_strlen($this->container['label_background_color_open']) < 0)) {
            $invalidProperties[] = "invalid value for 'label_background_color_open', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['label_text_color_close']) && (mb_strlen($this->container['label_text_color_close']) > 255)) {
            $invalidProperties[] = "invalid value for 'label_text_color_close', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['label_text_color_close']) && (mb_strlen($this->container['label_text_color_close']) < 0)) {
            $invalidProperties[] = "invalid value for 'label_text_color_close', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['label_background_color_close']) && (mb_strlen($this->container['label_background_color_close']) > 255)) {
            $invalidProperties[] = "invalid value for 'label_background_color_close', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['label_background_color_close']) && (mb_strlen($this->container['label_background_color_close']) < 0)) {
            $invalidProperties[] = "invalid value for 'label_background_color_close', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['icon_class_open']) && (mb_strlen($this->container['icon_class_open']) > 255)) {
            $invalidProperties[] = "invalid value for 'icon_class_open', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['icon_class_open']) && (mb_strlen($this->container['icon_class_open']) < 0)) {
            $invalidProperties[] = "invalid value for 'icon_class_open', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['icon_color_open']) && (mb_strlen($this->container['icon_color_open']) > 255)) {
            $invalidProperties[] = "invalid value for 'icon_color_open', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['icon_color_open']) && (mb_strlen($this->container['icon_color_open']) < 0)) {
            $invalidProperties[] = "invalid value for 'icon_color_open', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['icon_background_color_open']) && (mb_strlen($this->container['icon_background_color_open']) > 255)) {
            $invalidProperties[] = "invalid value for 'icon_background_color_open', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['icon_background_color_open']) && (mb_strlen($this->container['icon_background_color_open']) < 0)) {
            $invalidProperties[] = "invalid value for 'icon_background_color_open', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['icon_enabled_open']) && (mb_strlen($this->container['icon_enabled_open']) > 255)) {
            $invalidProperties[] = "invalid value for 'icon_enabled_open', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['icon_enabled_open']) && (mb_strlen($this->container['icon_enabled_open']) < 0)) {
            $invalidProperties[] = "invalid value for 'icon_enabled_open', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['icon_class_close']) && (mb_strlen($this->container['icon_class_close']) > 255)) {
            $invalidProperties[] = "invalid value for 'icon_class_close', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['icon_class_close']) && (mb_strlen($this->container['icon_class_close']) < 0)) {
            $invalidProperties[] = "invalid value for 'icon_class_close', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['icon_color_close']) && (mb_strlen($this->container['icon_color_close']) > 255)) {
            $invalidProperties[] = "invalid value for 'icon_color_close', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['icon_color_close']) && (mb_strlen($this->container['icon_color_close']) < 0)) {
            $invalidProperties[] = "invalid value for 'icon_color_close', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['icon_background_color_close']) && (mb_strlen($this->container['icon_background_color_close']) > 255)) {
            $invalidProperties[] = "invalid value for 'icon_background_color_close', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['icon_background_color_close']) && (mb_strlen($this->container['icon_background_color_close']) < 0)) {
            $invalidProperties[] = "invalid value for 'icon_background_color_close', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['icon_enabled_close']) && (mb_strlen($this->container['icon_enabled_close']) > 255)) {
            $invalidProperties[] = "invalid value for 'icon_enabled_close', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['icon_enabled_close']) && (mb_strlen($this->container['icon_enabled_close']) < 0)) {
            $invalidProperties[] = "invalid value for 'icon_enabled_close', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setIconBackgroundColor($icon_background_color)
    {
        ...
        if ((mb_strlen($icon_background_color) > 255)) {
            throw new \InvalidArgumentException('invalid length for $icon_background_color when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($icon_background_color) < 0)) {
            throw new \InvalidArgumentException('invalid length for $icon_background_color when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setIconColor($icon_color)
    {
        ...
        if ((mb_strlen($icon_color) > 255)) {
            throw new \InvalidArgumentException('invalid length for $icon_color when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($icon_color) < 0)) {
            throw new \InvalidArgumentException('invalid length for $icon_color when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setLabelTextColorOpen($label_text_color_open)
    {
        ...
        if ((mb_strlen($label_text_color_open) > 255)) {
            throw new \InvalidArgumentException('invalid length for $label_text_color_open when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($label_text_color_open) < 0)) {
            throw new \InvalidArgumentException('invalid length for $label_text_color_open when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setLabelBackgroundColorOpen($label_background_color_open)
    {
        ...
        if ((mb_strlen($label_background_color_open) > 255)) {
            throw new \InvalidArgumentException('invalid length for $label_background_color_open when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($label_background_color_open) < 0)) {
            throw new \InvalidArgumentException('invalid length for $label_background_color_open when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setLabelTextColorClose($label_text_color_close)
    {
        ...
        if ((mb_strlen($label_text_color_close) > 255)) {
            throw new \InvalidArgumentException('invalid length for $label_text_color_close when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($label_text_color_close) < 0)) {
            throw new \InvalidArgumentException('invalid length for $label_text_color_close when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setLabelBackgroundColorClose($label_background_color_close)
    {
        ...
        if ((mb_strlen($label_background_color_close) > 255)) {
            throw new \InvalidArgumentException('invalid length for $label_background_color_close when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($label_background_color_close) < 0)) {
            throw new \InvalidArgumentException('invalid length for $label_background_color_close when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setIconClassOpen($icon_class_open)
    {
        ...
        if ((mb_strlen($icon_class_open) > 255)) {
            throw new \InvalidArgumentException('invalid length for $icon_class_open when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($icon_class_open) < 0)) {
            throw new \InvalidArgumentException('invalid length for $icon_class_open when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setIconColorOpen($icon_color_open)
    {
        ...
        if ((mb_strlen($icon_color_open) > 255)) {
            throw new \InvalidArgumentException('invalid length for $icon_color_open when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($icon_color_open) < 0)) {
            throw new \InvalidArgumentException('invalid length for $icon_color_open when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setIconBackgroundColorOpen($icon_background_color_open)
    {
        ...
        if ((mb_strlen($icon_background_color_open) > 255)) {
            throw new \InvalidArgumentException('invalid length for $icon_background_color_open when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($icon_background_color_open) < 0)) {
            throw new \InvalidArgumentException('invalid length for $icon_background_color_open when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setIconEnabledOpen($icon_enabled_open)
    {
        ...
        if ((mb_strlen($icon_enabled_open) > 255)) {
            throw new \InvalidArgumentException('invalid length for $icon_enabled_open when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($icon_enabled_open) < 0)) {
            throw new \InvalidArgumentException('invalid length for $icon_enabled_open when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setIconClassClose($icon_class_close)
    {
        ...
        if ((mb_strlen($icon_class_close) > 255)) {
            throw new \InvalidArgumentException('invalid length for $icon_class_close when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($icon_class_close) < 0)) {
            throw new \InvalidArgumentException('invalid length for $icon_class_close when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setIconColorClose($icon_color_close)
    {
        ...
        if ((mb_strlen($icon_color_close) > 255)) {
            throw new \InvalidArgumentException('invalid length for $icon_color_close when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($icon_color_close) < 0)) {
            throw new \InvalidArgumentException('invalid length for $icon_color_close when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setIconBackgroundColorClose($icon_background_color_close)
    {
        ...
        if ((mb_strlen($icon_background_color_close) > 255)) {
            throw new \InvalidArgumentException('invalid length for $icon_background_color_close when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($icon_background_color_close) < 0)) {
            throw new \InvalidArgumentException('invalid length for $icon_background_color_close when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
    ...
    public function setIconEnabledClose($icon_enabled_close)
    {
        ...
        if ((mb_strlen($icon_enabled_close) > 255)) {
            throw new \InvalidArgumentException('invalid length for $icon_enabled_close when calling MultiButtonOptions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($icon_enabled_close) < 0)) {
            throw new \InvalidArgumentException('invalid length for $icon_enabled_close when calling MultiButtonOptions., must be bigger than or equal to 0.');
        }
