...
class ConditionUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The unique identifier of the `Condition` to update
     *
     * @return self
     */
     ...
     * Sets condition_type
     *
     * @param string|null $condition_type The type of this `Condition` (URL, GEO, or CHAT)
     *
     * @return self
     */
     ...
     * Sets filter_type
     *
     * @param string|null $filter_type Whether this condition includes or excludes the matched URLs
     *
     * @return self
     */
     ...
     * Sets match_type
     *
     * @param string|null $match_type The matching strategy used to evaluate the condition value
     *
     * @return self
     */
     ...
     * Sets match_value
     *
     * @param string|null $match_value The value to match against (e.g. URL path, country code)
     *
     * @return self
     */
