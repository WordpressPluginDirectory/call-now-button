...
class PrivateNoteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets text
     *
     * @param string $text Text content of the private note
     *
     * @return self
     */
     ...
     *
     * @param string|null $related_message_id ID of a message this note is related to
     *
     * @return self
     */
     ...
     * Sets attachment_ids
     *
     * @param string[] $attachment_ids List of media attachment IDs to include with the note
     *
     * @return self
     */
