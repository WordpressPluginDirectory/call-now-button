...
/**
 * PermissionAddRequest Class Doc Comment
 *
 * @category Class
 * @package  cnb\api
 * @author   OpenAPI Generator team
 ...
 */
class PermissionAddRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PermissionAddRequest';
    ...
    */
     ...
     * Sets member_id
     *
     * @param string $member_id The ID of the workspace member to grant permission to
     *
     * @return self
     */
     ...
     * Sets permission
     *
     * @param string $permission The permission type to grant
     *
     * @return self
     */
