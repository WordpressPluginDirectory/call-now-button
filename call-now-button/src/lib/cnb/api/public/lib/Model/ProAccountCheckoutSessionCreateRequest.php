...
/**
 * ProAccountCheckoutSessionCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  cnb\api
 * @author   OpenAPI Generator team
 ...
 */
class ProAccountCheckoutSessionCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProAccountCheckoutSessionCreateRequest';
    ...
    */
     ...
     * Sets plan
     *
     * @param string $plan The Stripe agency price/plan ID
     *
     * @return self
     */
     ...
     * Sets callback_uri
     *
     * @param string $callback_uri URI to redirect to after checkout completes or is cancelled
     *
     * @return self
     */
     ...
     * Sets ui_mode
     *
     * @param string|null $ui_mode UI mode for Stripe Checkout. Defaults to hosted.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Currency for the subscription. Defaults to the user's currency if set.
     *
     * @return self
     */
