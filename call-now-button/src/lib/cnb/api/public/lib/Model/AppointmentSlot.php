 ...
 *
 * @category Class
 * @description Represents an available appointment slot
 * @package  cnb\api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class AppointmentSlot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The unique identifier for this slot
     *
     * @return self
     */
     ...
     * Sets timezone
     *
     * @param string $timezone The timezone of the slot. Contains the ZoneId for these slots. (e.g. Europe/Amsterdam, America/Vancouver)
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title Optional title for the slot
     *
     * @return self
     */
