...
class TaxId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets country
     *
     * @param string $country Two-letter ISO country code for the tax ID
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param int $created Unix timestamp of when the tax ID was created
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Type of tax ID (e.g. eu_vat, us_ein)
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value The tax ID value
     *
     * @return self
     */
     ...
     * Sets verification
     *
     * @param \cnb\api\Model\Verification $verification Verification details for the tax ID
     *
     * @return self
     */
