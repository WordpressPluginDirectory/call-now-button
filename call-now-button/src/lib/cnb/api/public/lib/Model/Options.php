...
class Options implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \cnb\api\Model\Persona[] $default_assignees List of persona IDs set as default assignees for chat conversations
     *
     * @return self
     */
     ...
     *
     * @param \cnb\api\Model\WsMember[] $default_email_notification List of workspace members who receive default email notifications
     *
     * @return self
     */
     ...
     *
     * @param int $default_email_delay Delay in minutes before sending an email notification about a new chat message (-1 to disable)
     *
     * @return self
     */
     ...
     *
     * @param int $default_inactivity_limit Inactivity limit in minutes before a conversation is considered inactive (-1 to disable)
     *
     * @return self
     */
