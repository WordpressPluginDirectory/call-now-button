...
class WorkspaceOptionsUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param int $default_email_delay After how many minutes to send an email notification about a new chat message (-1 to disable).
     *
     * @return self
     */
     ...
     *
     * @param int $default_inactivity_limit The default inactivity limit in minutes (-1 to disable).
     *
     * @return self
     */
